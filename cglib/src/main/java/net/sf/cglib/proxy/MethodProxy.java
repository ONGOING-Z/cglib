...
/**
 * <p>CGLIB的MethodProxy底层使用FastClass机制，比标准反射调用快约10倍</p>
...
public class MethodProxy {
    ...
    /**
     * <p>触发代理对象。重新走代理逻辑（可能递归）</p>
     * Invoke the original method, on a different object of the same type. // 这注释有些误导人，问了deepseek，它也是这么认为的。
     * @param obj (这里的 obj 必须是代理对象的实例)the compatible object; recursion will result if you use the object passed as the first
